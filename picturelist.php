...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/info.dwt.php" codeOutsideHTMLIsLocked="false" -->
<head>
...
<div class="container">
  ...
  <div class="content">
    <table width="850" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="122">Number</td>
        <td width="728"> This is a temporary site. it will be removed when its no longer needed.</td>
      </tr>
      <tr>
        <td>1</td>
        <td><img src="images/houses/IMAG0187.jpg" alt="" name="house1" width="200" height="150" id="house1" /></td>
      </tr>
      <tr>
        <td>2</td>
        <td><img src="images/houses/IMAG0189.jpg" alt="" name="house1" width="200" height="150" id="house2" /></td>
      </tr>
      <tr>
        <td>3</td>
        <td><img src="images/houses/IMAG0190.jpg" alt="" name="house1" width="200" height="150" id="house3" /></td>
      </tr>
      <tr>
        <td>4</td>
        <td><img src="images/houses/IMAG0191.jpg" alt="" name="house1" width="200" height="150" id="house4" /></td>
      </tr>
      <tr>
        <td>5</td>
        <td><img src="images/houses/IMAG0192.jpg" alt="" name="house1" width="200" height="150" id="house5" /></td>
      </tr>
      <tr>
        <td>6</td>
        <td><img src="images/houses/IMAG0193.jpg" alt="" name="house1" width="200" height="150" id="house6" /></td>
      </tr>
      <tr>
        <td>7</td>
        <td><img src="images/houses/IMAG0195.jpg" alt="" name="house1" width="200" height="150" id="house7" /></td>
      </tr>
      <tr>
        <td>8</td>
        <td><img src="images/houses/IMAG0199.jpg" alt="" name="house1" width="200" height="150" id="house8" /></td>
      </tr>
      <tr>
        <td>9</td>
        <td><img src="images/houses/IMAG0202.jpg" alt="" name="house1" width="200" height="150" id="house9" /></td>
      </tr>
      <tr>
        <td>10</td>
        <td><img src="images/houses/IMAG0210.jpg" alt="" name="house1" width="250" height="150" id="house10" /></td>
      </tr>
      <tr>
        <td>11</td>
        <td><img src="images/houses/IMAG0199.jpg" alt="" name="house1" width="200" height="150" id="house11" /></td>
      </tr>
      <tr>
        <td>12</td>
        <td><img src="images/houses/IMAG0211.jpg" alt="" name="house1" width="200" height="150" id="house12" /></td>
      </tr>
      <tr>
        <td>13</td>
        <td><img src="images/houses/IMAG0250.jpg" alt="" name="house1" width="200" height="150" id="house13" /></td>
      </tr>
      <tr>
        <td>14</td>
        <td>&nbsp;</td>
