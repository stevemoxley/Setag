...
<div class="container">
  ...
  <div class="menubar">
  	<div class="buttons"><table width="935" height="33" border="0" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <div class="content"><table width="850" border="0" cellpadding="0" cellspacing="0" class="boxes">
  <tr>
    <td width="480" rowspan="2">  <span id="h3font">
    <h3>Welcome to Setag.net</h3></span>
      <span id="pagefont2"><p>Search our available properties right now for FREE by clicking the Propeties tab!</p></span>
      <span id="pagefont"><p>Setag Corporation has owned properties in the St. Louis area for 40 years. <br /><br />Setag specializes in single family housing in the St. Louis area. Our goal is simply this - <i>keep our tenants happy.</i><br /><br /> Setag offers full maintenance service to all of our tenants at little or no extra charge.</br><br /><br />
      Our kind and courteous staff is there to help you Monday - Friday 8:00AM - 12:00PM.<br /><br />Tenants can mail checks or drop them off at our convenient office location in Winchester, MO. 
      </p>
      </span></td><td width="355" height="100"><span id="h3font"><h3>&nbsp;</h3></span></td>
