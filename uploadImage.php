...
<div class="container">
  ...
  <br />Select an Image to Upload
	...
	$target_path = "images/houses/";
	$target_path = $target_path . basename( $_FILES['ffile']['name']); 
	
	if($_POST['submit'] <> ''){
	
			if(move_uploaded_file($_FILES['ffile']['tmp_name'], $target_path)) {
			echo "The file ".  basename( $_FILES['ffile']['name']). 
			" has been uploaded";
		} else{
