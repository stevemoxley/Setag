...
<div class="container">
  ...
  <div class="content"><h2>Edit Properties</h2>
    <?
        ...
        <tr id="pagetext2">
        <td width="122" id="pagetext1"><strong>Address</strong></td>
        <td width="243" id="pagetext1"><strong>Headline</strong></td>
                <td width="59" id="pagetext1"><strong>Bed</strong></td>
                <td width="59" id="pagetext1"><strong>Bath</strong></td>
                <td width="136" id="pagetext1"><strong>Location</strong></td>
                <td width="104" id="pagetext1"><strong>Rent</strong></td>
                <td width="94" id="pagetext1"><strong>Listed</strong></td>
                <td width="83" id="pagetext1"><strong>Edit</strong></td>
        </tr>
		...
		while ($row = mysql_fetch_assoc($fetch)) {
			...
			$address = $row['address'];
			if($listed == 1){
				$listed = "<font color=\"#00CC00\">Yes</font>";
			}else{
				$listed = "<font color=\"#990000\">No</font>"; }
			echo "<form id=\"form1\" name=\"form1\" method=\"post\" action=\"editpage.php\"><tr><td id=\"pagetext2\" width=\"50\">".$address."</td><td id=\"pagetext2\">".$sdesc."</td><td id=\"pagetext2\">".$rooms."</td><td id=\"pagetext2\">".$bath."</td><td id=\"pagetext2\">".$location."</td><td id=\"pagetext2\">$ ".$rent."</td><td id=\"pagetext2\">".$listed."</td><td id=\"pagetext2\" ><input type=\"submit\" name=\"edit\"  id=\"edit\" value='$id' /></td></tr></form>";
		}			
