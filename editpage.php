...
<div class="container">
  ...
  <div class="content"><h2>
...

	{
		...
		$fetch = mysql_query("SELECT * FROM properties WHERE propid='$id'");

		$get = mysql_fetch_array($fetch);

		$olddesc = $get['description'];
		...
		$oldbath = $get['bathrooms'];

		$oldsdesc = $get['shortdescription'];
		
		$oldlocation = $get['location'];
		
		$oldaddress = $get['address'];
  ...
  ?>
    ...
    <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
      <table width="900" border="0" cellpadding="5" cellspacing="5" id="table2" height="300">
        <tr>
          <td height="30" colspan="5" id="header">Edit  Property</td>
          </tr>
        <tr>
          <td width="181" height="30">Address:<br />
            <span class="subtext" id="subtext">(Never shown on the website)</span></td>
          <td height="30"><input name="address" value=" <? echo $oldaddress; ?>" type="text" class="textboxes" id="address" /></td>
          <td>&nbsp;</td>
          <td>Headline:</td>
          <td><input name="shortdescription" value=" <? echo $oldsdesc; ?>" type="text" class="textboxes" id="shortdescription"/></td>
        </tr>
        <tr>
    <td width="181"></span>Location:</td>
    <td width="279"><input name="location" type="text"  value=" <? echo $oldlocation; ?>" class="textboxes" id="location2" /></td>
    <td width="1">&nbsp;</td>
    <td width="101"><label for="bathrooms"></label>
    Number of Bedrooms:</td>
    <td width="279"><input name="rooms" type="text" class="textboxes" id="rooms"value=" <? echo $oldrooms; ?>" /></td>
        </tr>
  <tr>
    <td colspan="2">Long Property Description :</td>
    <td>&nbsp;</td>
    <td>Number of Bathrooms:</td>
    <td><input name="bathrooms" value=" <? echo $oldbath; ?>" type="text" class="textboxes"/></td>
  </tr>
  <tr>
    <td colspan="2"><label for="description"></label>
      <textarea name="description" cols="45" rows="5" class="largetext" id="description2" value=" "><? echo $olddesc; ?></textarea></td>
    <td rowspan="3">&nbsp;</td>
    <td>Rent:
      <label for="address"></label></td>
    <td><input name="rent" type="text" value=" <? echo $oldrent; ?>" class="textboxes" id="rent" /></td>
  </tr>
  <tr>
    <td colspan="2">Notes:</td>
    <td><label for="test"></label></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2"><textarea name="notes" cols="45" rows="5" class="largetext"id="description2 "value=" "><? echo $oldnotes; ?></textarea></td>
    <td colspan="2">&nbsp;</td>
  </tr>
      </table>
<br />
