...
<div class="container">
  ...
  <div class="content">
	...
	echo "<br><br>Property ID: ".$id." has been updated successfully<br><br>";
	...
	if($desc <> ''){
		...
		$result = mysql_query("UPDATE properties SET description='$desc' WHERE propid='$id'") 

or die(mysql_error());  

	}if($notes <> ''){

		$result = mysql_query("UPDATE properties SET notes='$notes' WHERE propid='$id'") 

or die(mysql_error());  

	}if($rent <> ''){

		$result = mysql_query("UPDATE properties SET rent='$rent' WHERE propid='$id'") 

or die(mysql_error()); 

	}if($location <>''){

		$update = mysql_query("UPDATE properties SET location='$location' WHERE propid='$id'");

	}if($sqft <> ''){

		$update = mysql_query("UPDATE properties SET sqft='$sqft' WHERE propid='$id'");

	}

	$update = mysql_query("UPDATE properties SET bathrooms='$bath' WHERE propid='$id'");

	$update = mysql_query("UPDATE properties SET rooms='$rooms' WHERE propid='$id'");

	$update = mysql_query("UPDATE properties SET listed='$listed' WHERE propid='$id'");

	$update = mysql_query("UPDATE properties SET shortdescription='$shdesc' WHERE propid='$id'");
  ...
  ?>
      ...
      <p><a href="adminpanel.php" id="emaillink">Property Panel</a></p>
