...
<div class="container">
  ...
  <div class="content"><h2>Remove a Property</h2>
    ...
    echo "No houses found in the database";
	}else{
		
		//OUTPUT all properties
		echo "<table border=\"1\"><tr><td><b>Address</b></td><td><b>Delete</b></td></tr>";
		while ($row = mysql_fetch_assoc($result)) {
			...
			$bath = $row['bathrooms'];
			$address = $row["address"];
			echo "<tr><td>".$address."</td><td><input type=\"radio\" name=\"prop\" id=\"prop\" value='".$id."'></td></tr>";
			}
		echo "</table>";
	}
    ...
    <?
	  if(($_POST['submit'] <> '') && ($_POST['prop'] <> ''))
			{
				deleteProp($_POST['prop']);
				echo "<br><center><i>Property Deleted</i></center>";
				?> <script type="text/javascript">
				window.location = "http://www.setag.net/removeprop.php"
