...
<div class="container">
  ...
  <div class="content">
    ...
    <table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="26" align="center"><img src="<? echo $url; ?>" alt="" name="largeimg" width="678" height="360" id="largeimg" class="imgborder" /></td>
      </tr>
      <tr>
        <td height="27" colspan="26" align="center">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="25"><span class="sdescfont"><? echo $sdesc; ?></span></td>
        <td width="424">&nbsp;</td>
      </tr>
      <tr>
        <td colspan="25">&nbsp;</td>
      ...
      <tr>
        <td colspan="24">in <? echo $location; ?></td>
        <td width="116" rowspan="5">&nbsp;</td>
        <td rowspan="5"><p>Call to schedule a viewing</p>
          <p>(636)220-7501</p></td>
        </tr>
      <tr>
        <td colspan="24">Rent: $<? echo $rent; ?></td>
      </tr>
      <tr>
        <td colspan="24">Bedrooms: <? echo $rooms; ?></td>
      </tr>
      <tr>
        <td colspan="24">Bathrooms: <? echo $bathrooms ; ?></td>
        </tr>
      <tr>
        <td colspan="24">&nbsp;</td>
        </tr>
