...
<div class="container">
  ...
  <div class="content">
    <div class ="boxes"><h3 id="h3font">Welcome to Setag</h3>
    <p id="pagefont">Setag Property Management has provided St Louis County with over 40 years of quality property management service.<br /><br />
    Our family owned and operated company takes great pride delivering prompt courteous service.</p></div><br />
    <center> 
      <table width="850" border="0" cellpadding="0" cellspacing="0" class="boxes">
        <tr>
          <td width="265"><center><img src="images/apartments.png" alt="" name="apartments" width="250" height="250" id="apartments" /></center></td>
          <td width="35">&nbsp;</td>
          <td width="250"><center><img src="images/duplexes.png" alt="" name="duplexes" width="250" height="250" id="duplexes" /></center></td>
          <td width="35">&nbsp;</td>
          <td width="265"><center><img src="images/homes.png" alt="" name="homes" width="250" height="250" id="homes" /></center></td>
          </tr>
      </table></center>
    <br />
    <div class="boxes"><p>Our goal has remained the same since we opened our doors many years ago; simply treat customers fairly and with respect, which serves as the cornerstone for our success.</p>
      <p>Thanks, <br />
        <br />
        <strong>Your Setag Family</strong><br />
      </p>
    </div>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
