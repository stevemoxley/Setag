...
<div class="container">
 ...
 <div id ="editorpanel" align="center">
   <table width="750" height="194" border="0" align="left" cellpadding="0" cellspacing="0">
     <tr>
       <td height="153" colspan="2"><div id="properties">
         <p id="label1">Properties</p>
         <table width="500" border="0" cellpadding="0" cellspacing="00">
           <tr>
             <td width="40">&nbsp;</td>
             <td width="37"><a href="addprop.php"><img src="images/buttons/add.png" alt="" name="add" width="24" height="24" id="add" border="0"/></a></td>
             <td width="223"><a href="addprop.php" id="linkpage">Add Property</a></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
             <td><img src="images/buttons/remove.png" alt="" name="remove" width="24" height="12" id="remove" /></td>
             <td><a href="removeprop.php" id="linkpage">Remove Property</a></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
             <td><img src="images/buttons/wrench.png" alt="" name="wrench" width="24" height="24" id="wrench" /></td>
             <td><a href="editprop.php" id="linkpage">Edit Properties</a></td>
           </tr>
       </table>
<p>&nbsp;</p>
       </div></td>
       <td width="372" colspan="2">
       <div id="imageupload"><p id="label1"> Image Upload PANEL</p>
         <table width="500" border="0" cellpadding="0" cellspacing="00">
           <tr>
             <td width="40">&nbsp;</td>
             <td width="37"><a href="addprop.php"><img src="images/buttons/add.png" alt="" name="add" width="24" height="24" id="add" border="0"/></a></td>
             <td width="223"><a href="uploadImage.php" id="linkpage">Upload Image</a></td>
           </tr>
           <tr>
             <td>&nbsp;</td>
             <td><img src="images/buttons/remove.png" alt="" name="remove" width="24" height="12" id="remove" /></td>
