...
<div class="container">
  ...
  if(ISSET($_SESSION['username']) && ISSET($_SESSION['password'])){
	  ?><script type="text/javascript">
		  window.location = "http://www.setag.net/adminpanel.php"
		  </script><?
  } 
  //Show login form. WORKING. Dont mess with it.
  else{
	echo"<center><form id=\"form1\" name=\"form1\" method=\"post\" action=\"\">";
    echo"<p>";
  ...
  if($_POST['username'] <> ''){
	  if($_POST['pass'] <> ''){
		  ...
		  echo "<BR><BR>Please type in a password";
	  }
  }  }
  ?>
